package com.wisegas.common.security.spring.oauth2.google;
...
public class GoogleTokenServices extends RemoteTokenServices {
   ...
   private Map<String, Object> exchangePost(String path, HttpHeaders headers, MultiValueMap<String, String> formData) {
      ...
      return restTemplate.exchange(path, HttpMethod.POST, new HttpEntity<>(formData, headers), new ParameterizedTypeReference<Map<String, Object>>() {}).getBody();
   }
