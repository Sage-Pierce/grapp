...
public class PolygonGraphGenerator {
    ...
    public Graph generate(Collection<Point> waypoints) {
        ...
        Map<Point, MutableGraphPoint> points =
            generationPoints.stream().collect(toMap(GraphGenerationPoint::getPoint, graphGenerationPoint -> new MutableGraphPoint(graphGenerationPoint.getPoint())));
