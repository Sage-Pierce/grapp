...
class StartDistanceWaypointComparatorFactoryTest extends Specification {

   private WaypointComparatorFactory waypointComparatorFactory = new StartDistanceWaypointComparatorFactory()

   def "Waypoints are sorted in ascending order of distance from start"() {
      given:
      ...
      then:
      waypoints == [waypoint1, waypoint3, waypoint2, waypoint4, waypoint6, waypoint5]
   }
}
